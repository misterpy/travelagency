...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$layout             = DF_part_layout::df_get_layout_content_class();
	$meta_sb_off_canvas = get_post_meta( $page_id, 'df_metabox_layout_sidebar_offcanvas', true );

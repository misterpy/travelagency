...
$df_homepage_layout = is_archive() ? $df_options[ 'archive_layout' ] : $df_options[ 'blog_layout' ];
		...
		<div class="wrap">
			...
			<?php if ( is_single( get_the_ID() ) ) : // If viewing a single post. ?>
				...
				<div <?php dahz_attr('entry-content');?>>
					...
					<div class="df_content-bg aside-icon"></div>
			...
			<?php else: // If not viewing a single post. ?>
				...
				<div <?php dahz_attr( 'entry-content' ); ?>>
					...
					<?php if( $df_bg_mode_lay != '1' && ($df_homepage_layout == 'list' || ( $df_homepage_layout == 'grid' && $df_grid_type == 'masonry' ) ) ): ?>
						<div class="df_content-bg aside-icon"></div>
					<?php endif; ?>

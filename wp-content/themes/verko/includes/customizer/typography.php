...
add_action( 'customize_register', 'df_customizer_typography', 110 );
function df_customizer_typography( $wp_customize ){
  ...
  $wp_customize->add_setting( 'df_options[nav_font_weight]', array( 'type' => 'option', 'default' => '' ) );

  $wp_customize->add_setting( 'df_options[heading_font_family]', array( 'type' => 'option', 'default' => 'Dosis' ) );
  $wp_customize->add_setting( 'df_options[heading_font_weight]', array( 'type' => 'option', 'default' => '' ) );

  $wp_customize->add_setting( 'df_options[body_font_family]', array( 'type' => 'option', 'default' => 'Karla' ) );
  $wp_customize->add_setting( 'df_options[body_font_weight]', array( 'type' => 'option', 'default' => '' ) );

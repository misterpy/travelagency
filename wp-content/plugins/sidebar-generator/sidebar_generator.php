...
Description: This plugin generates as many sidebars as you need. Then allows you to place them on any page you wish. Version 1.2.1 now supports themes with multiple sidebars, and already modify by Dahz. 
Version: 1.2.1
Author: Kyle Getson
...
class sidebar_generator {
	...
	function sidebar_generator(){
		...
		//edit posts/pages
		add_action('submitpost_box', array($this, 'edit_form'));
		add_action('submitpage_box', array($this, 'edit_form'));
		...
		add_action('submitpage_box', array($this, 'save_form'));
	...
	*/
	...
	<div id='sbg-sortables' class='meta-box-sortables'>
		<div id="sbg_box" class="postbox " >
			<div class="handlediv" title="Click to toggle"><br /></div><h3 class='hndle'><span>Sidebar Generator</span></h3>
			<div class="inside">
				<div class="sbg_container">
					<input name="sbg_edit" type="hidden" value="sbg_edit" />
					
					<p>
						Select the sidebar you wish to display on this page. If you don't want to display a Sidebar, select the <b>"One-Col"</b> layout.<br />
						<strong>Note:</strong> You must first create the sidebar under Appearance > <a href="<?php echo esc_url(admin_url('themes.php?page=multiple_sidebars')); ?>">Sidebars</a>. 
					</p>
					<ul>
					<?php 
					global $wp_registered_sidebars;

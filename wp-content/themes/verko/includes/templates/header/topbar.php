...
$header_topbar = ( $df_options['header_topbar'] == 1 ) ;
$inline_css = '' ;
if( $_is_customizing ){
  $header_topbar = true ;
  $inline_css    = ( $df_options['header_topbar'] == 1 ) ? 'style=display:block;' : 'style=display:none;';
}
// TODO : Create Ads.
if( $header_topbar ): ?>
...
<div class="df-topbar" <?php echo esc_attr( $inline_css ); ?>>
	<div class="<?php echo esc_attr( $df_header_topbar_classes ) ?> col-full">
	  <div class="df-topbar-left col-left">
      	  ...
      	  <?php
           $df_topbar_content = $df_options['header_topbar_content'];

...
if ( !function_exists( 'df_pagenav' ) ) :
    function df_pagenav() {
        ...
        if ($GLOBALS['wp_query']->max_num_pages < 2) : return; endif;

        echo '<div class="clear"></div>';
        echo '<nav class="navigation paging-navigation col-full df-next-prev-pagination" role="navigation">';
...
if ( !function_exists( 'df_pagenav_number' ) ) :
    function df_pagenav_number() {
        ...
        if ( is_rtl() ) :
            $next_text_pagination = '<i class="md-keyboard-arrow-left"></i>';
            $prev_text_pagination = '<i class="md-keyboard-arrow-right"></i>';
        else :
            $next_text_pagination = '<i class="md-keyboard-arrow-right"></i>';
            $prev_text_pagination = '<i class="md-keyboard-arrow-left"></i>';
        endif;
...
if ( !function_exists( 'df_pagenav_infinite_scroll' ) ) :
    function df_pagenav_infinite_scroll() {
        ...
        echo '<nav class="navigation paging-navigation col-full df-infi-scr" role="navigation">';
        echo '<div class="nav-links">';
        if ( get_next_posts_link() ) :
...
if ( !function_exists( 'df_pagenav_infinite_scroll_button' ) ) :
    function df_pagenav_infinite_scroll_button() {
        ...
        echo '<nav class="navigation paging-navigation col-full df-infi-scr-btn" role="navigation">';
        echo '<div class="nav-links">';
        if ( get_next_posts_link() ) :

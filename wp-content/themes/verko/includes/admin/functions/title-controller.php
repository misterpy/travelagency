...
function df_page_title_header_controller() {
    $df_options = get_option( 'df_options' );
 	...
 	$page_title_bg_color = $df_options['page_header_title_bg_color'];
 	$page_title_height   = $df_options['page_header_title_height'];
...
function df_fancy_title_header_controller() {
  ...
  $fancy_parallax_speed = get_post_meta( $post_id, 'df_metabox_fancy_parallax_speed', true );
	...
	if ( $page_title_background_image ) {
			...
			$repeat 	= get_post_meta( $post_id, 'df_metabox_repeat_options', true );
			$position_x = get_post_meta( $post_id, 'df_metabox_repeat_x', true );
			$position_y = get_post_meta( $post_id, 'df_metabox_repeat_y', true );
...
if( ! function_exists( 'df_slider_title_header_controller' ) ) :
 ...
 function df_slider_title_header_controller() {
    ...
    $master_slider = get_post_meta( $post_id, 'df_metabox_master_slider', true);

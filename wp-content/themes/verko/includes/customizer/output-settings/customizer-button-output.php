 ...
 *
  ================================================================================= */
$df_btn_style    			= $df_options[ 'df_button_style' ];
// color
$df_btn_text_color			= $df_options[ 'df_button_text_color' ];
$df_btn_bg_color			= $df_options[ 'df_button_bg_color' ];
$df_btn_bottom_color		= $df_options[ 'df_button_bottom_color' ];
$df_btn_border_color		= $df_options[ 'df_button_border_color' ];
// color hover
$df_btn_text_color_hover	= $df_options[ 'df_button_text_hover_color' ];
$df_btn_bg_color_hover		= $df_options[ 'df_button_bg_hover_color' ];
$df_btn_bottom_hover_color	= $df_options[ 'df_button_bottom_hover_color' ];
$df_btn_border_color_hover	= $df_options[ 'df_button_border_hover_color' ];

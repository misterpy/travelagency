...
if ( ! function_exists( 'df_layout_body_class' ) ) :
    ...
    function df_layout_body_class( $classes ) {
        ...
        $df_button_style    = $df_options['df_button_style'];
        ...
        $meta_sb_off_canvas  = get_post_meta( get_the_ID(), 'df_metabox_layout_sidebar_offcanvas', true );
...
if ( ! function_exists( 'df_page_template_menu_filter' ) ) :
    ...
    function df_page_template_menu_filter( $args ) {
        ...
        {
            $page_primary_menu = get_post_meta( $page_id, 'df_metabox_custom_menu', true );

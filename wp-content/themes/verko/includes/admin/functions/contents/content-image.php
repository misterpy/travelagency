...
if ( !function_exists( 'df_ftr_image_list' ) ) :
    function df_ftr_image_list() {
        ...
        if ( !is_single() && $df_blog_layout == 'list' ):
            ...
            if ( $post_format_gal ) :
                $order = array( 'callback' );
            elseif ( $post_format_img ) :
            ...
            ( $post_format_std || $post_format_img || $post_format_gal ) ? get_the_image( $image_args ) : '';
        endif;
    }
endif;
...
if ( !function_exists( 'df_ftr_image_single' ) ) :
    function df_ftr_image_single() {
        $df_options         = get_option( 'df_options' );
        $df_show_feat_image = $df_options[ 'feat_image' ];
